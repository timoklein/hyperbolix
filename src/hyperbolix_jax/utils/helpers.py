...
def compute_pairwise_distances(
    ...
    Examples:
        ...
        >>> from hyperbolix_jax.utils.helpers import compute_pairwise_distances
        >>>
...
def compute_hyperbolic_delta(distmat: Float[Array, "n_points n_points"], version: str = "average") -> Float[Array, ""]:
    ...
    Examples:
        >>> import jax.numpy as jnp
        >>> from hyperbolix_jax.utils.helpers import compute_hyperbolic_delta
        >>>
...
def get_delta(
    ...
    Examples:
        ...
        >>> import jax.numpy as jnp
        >>> from hyperbolix_jax.manifolds import hyperboloid
        >>> from hyperbolix_jax.utils.helpers import get_delta
        >>>
        >>> # Generate random hyperboloid points
