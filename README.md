...
- ✅ **4,400+ tests passing** (1,029 test functions, parametrized across dtypes, dimensions, manifolds) checked against independently transcribed NumPy/SciPy oracles
